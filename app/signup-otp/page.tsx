...
import { Mail, Shield, RefreshCw, ArrowLeft, Pickaxe } from "lucide-react"
      ...
      <div className="w-full max-w-md">
        ...
        <Card className="bg-card/95 backdrop-blur-sm border-0 shadow-2xl">
          <CardHeader className="pb-4">
            <CardTitle className="text-2xl font-bold text-center text-card-foreground">Email Verification</CardTitle>
          </CardHeader>
          <CardContent className="space-y-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pl-10 h-12 text-center text-lg font-mono tracking-widest bg-input border-border focus:border-primary focus:ring-primary"
                    placeholder="000000"
                  />
                </div>
              ...
              <Button
                ...
                variant="outline"
                className="w-full h-12 border-border text-card-foreground hover:bg-accent font-semibold bg-transparent"
                disabled={isLoading || isResending}
              >
                {isResending ? (
                  <div className="flex items-center space-x-2">
