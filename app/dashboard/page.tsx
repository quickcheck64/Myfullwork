...
export default function CryptoMiningDashboard() {
  ...
  const calculateGrowthPercentage = () => {
    if (!dashboardAnalytics?.growth_metrics) return 0
    // Use the growth_rate from API data instead of static multiplier
    return dashboardAnalytics.growth_metrics.growth_rate || 0
  }

  const calculateAssetAllocation = () => {
    if (!dashboardAnalytics?.portfolio_overview) return { bitcoin: 0, ethereum: 0 }
