      ...
      default:
        return (
          <div className="px-4 py-6 space-y-6">
            ...
            <PortfolioOverview
              total_value_usd={dashboardAnalytics.portfolio_overview.total_value_usd}
              bitcoin_balance={dashboardAnalytics.portfolio_overview.bitcoin_balance}
              ethereum_balance={dashboardAnalytics.portfolio_overview.ethereum_balance}
              bitcoin_value_usd={dashboardAnalytics.portfolio_overview.bitcoin_value_usd}
              ethereum_value_usd={dashboardAnalytics.portfolio_overview.ethereum_value_usd}
              asset_allocation={dashboardAnalytics.portfolio_overview.asset_allocation}
              active_mining_sessions={dashboardAnalytics.mining_performance.active_sessions}
            />
