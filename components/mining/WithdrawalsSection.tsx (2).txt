                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <p className="font-medium">
                          {safeFormatCrypto(withdrawal.amount, 8)} {withdrawal.crypto_type.toUpperCase()}
                        </p>
                        <p className="text-sm text-muted-foreground">{safeFormatCurrency(withdrawal.usd_amount)}</p>
